...
class WidgetCustomMenu extends \CE\WidgetBase
{
    ...
    protected function registerControls()
    {
        ...
        $repeater->addControl('item_icon', ['label' => 'Εικονίδιο', 'type' => 'icon', 'condition' => ['item_type!' => 'html']]);
        ...
        $this->addControl('dropdown_animation', [
            'label' => 'Είσοδος Dropdown', 'type' => 'select', 'default' => 'move-up',
        ...
        // 5. BRANDING (ΜΕΤΑΦΕΡΘΗΚΕ ΣΤΟ ΤΕΛΟΣ)
    ...
    protected function render()
    {
        ...
        foreach ($menu_tree as $m) {
            ...
            if (!empty($m['item_icon']['value'])) echo '<i class="'.htmlspecialchars($m['item_icon']['value']).'" aria-hidden="true"></i>';
